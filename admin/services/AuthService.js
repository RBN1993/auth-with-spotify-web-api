...
export default class AuthService {
  ...
  login() {
    ...
    // Guardamos el state para poder verificarlo después del redirect
    localStorage.setItem('auth_state', state)

    //Configuramos la request del redirect
    let url = 'https://accounts.spotify.com/authorize'
    //concatenamos los diferente parámetros para el implicit grant
  ...
  handleAuthentication() {
    // Usamos una promesa para poder delegar el redireccionamiento
